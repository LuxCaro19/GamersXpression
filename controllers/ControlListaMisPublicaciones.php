...
class ControlListaPublicaciones
{
    ...
    public function listarPublicaciones(){
        session_start();
        $USR = $_SESSION['user']['id_usuario'];
        $megusta = new MeGusta;
        $publicacion = new Publicacion;
        //cuenta cuantos resultados arrojara la busqueda
        $total = $publicacion->contarPublicacionesWhere($this->busqueda,$USR);   
        ...
        $juegos = $publicacion->cargarPublicacionesWhere($this->busqueda, $this->pagina, $this->cantidad,$USR);
